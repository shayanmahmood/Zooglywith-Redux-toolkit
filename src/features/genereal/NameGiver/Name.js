...
import { setname } from "../slice/generealSlice"

function Name() {
    // const { name, settingName } = useFuture()
    const { name } = useSelector(store => store.general)
                ...
                <div class="modal__col">
                    <div class="modal__content">
                        ...
                        <div class="modal__actions">
                            <input type="text" placeholder="Enter Your Name Here!" value={name} onChange={setName} style={{
                                marginTop: '-15px',
                                marginLeft: '-15px',
                                width: '100%',
                                height: '40px',
